<x-app-layout>
    ...
    <div class="card-body">
        <form action="{{ route('dashboard.finances.incomes.update', $income) }}" method="post">
            ...
            <div class="mb-3 row">
                <label for="value" class="col-md-2 col-form-label text-md-end">Valor</label>
            ...
            <div class="mb-3 row">
                <label for="ref_date" class="col-md-2 col-form-label text-md-end">Data</label>
            ...
            <div class="mb-3 row">
                <label for="income_category" class="col-md-2 col-form-label text-md-end">Categoria</label>
            ...
            <div class="mb-3 row">
                <label for="account" class="col-md-2 col-form-label text-md-end">Conta</label>
            ...
            <div class="mb-3 row">
                <label for="member" class="col-md-2 col-form-label text-md-end">Membro</label>
