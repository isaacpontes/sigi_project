...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Editar Categoria - {{ $expense_category->name }}</div>
                ...
                <div class="card-body">
                  <form action="{{ route('dashboard.expense_categories.update', $expense_category) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <textarea id="add_info" type="add_info" class="form-control @error('add_info') is-invalid @enderror" name="add_info">{{ $expense_category->add_info }}</textarea>
