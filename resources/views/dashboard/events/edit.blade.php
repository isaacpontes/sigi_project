...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Editar Evento - {{ $event->name }}</div>
                ...
                <div class="card-body">
                  <form action="{{ route('dashboard.events.update', $event) }}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input id="happens_at" type="datetime" class="form-control" name="happens_at" value="{{ $event->happens_at }}" required autofocus>
                        </div>
                    </div>
