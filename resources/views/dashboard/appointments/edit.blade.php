<x-app-layout>
    ...
    <div class="card-body">
        ...
        <div class="mb-3 row">
            <label for="happens_at" class="col-4 col-form-label text-md-end">Data e Hora</label>
        ...
        <div class="mb-3 row">
            <label for="add_info" class="col-4 col-form-label text-md-end">Outras Informações</label>
        ...
        <div class="mb-3 row">
            <label for="completed" class="col-4 col-form-label text-md-end">Completado?</label>

            <div class="col-2 offset-md-1 form-check form-check-inline">
