<x-app-layout>
    ...
    <div class="card-body">
        ...
        <div class="mb-3 row">
            <label for="happens_at" class="col-2 col-form-label text-md-end">Data e Hora</label>
        ...
        <div class="mb-3 row">
            <label for="add_info" class="col-2 col-form-label text-md-end">Outras Informações</label>
