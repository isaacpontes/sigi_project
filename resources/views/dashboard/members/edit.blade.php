...
@section('content')
    <main role="main" class="col-md-9 ml-sm-auto bg-white col-lg-10 pt-3 px-4">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="status" class="col-md-2 col-form-label text-md-right">Situação</label>
            ...
            <div class="form-group row">
                <label for="admission" class="col-md-2 col-form-label text-md-right">Admissão Por</label>
            ...
            <div class="form-group row">
                <label for="admission_date" class="col-md-2 col-form-label text-md-right">Data de Admissão</label>
            ...
            <div class="form-group row">
                <label for="demission" class="col-md-2 col-form-label text-md-right">Saída Por</label>
            ...
            <div class="form-group row">
                <label for="demission_date" class="col-md-2 col-form-label text-md-right">Data de Saída</label>
