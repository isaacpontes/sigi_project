...
<body>
  ...
  <div>
    ...
    <p class="ml-lg">Total de membros no fim do período: {{ $active_members->count() }}</p>
    <p class="ml-lg">Novos membros durante o período: {{ $new_members->count() }}</p>
    <p class="ml-lg">Membros desligados durante o período: {{ $new_inactive_members->count() }}</p>
    <hr>
