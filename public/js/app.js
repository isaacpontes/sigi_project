...
window.addEventListener('DOMContentLoaded', function () {
  var $elementesToConfirm = document.querySelectorAll('.delete-confirmation');

  if ($elementesToConfirm.length > 0) {
    $elementesToConfirm.forEach(function ($el) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunksigi_project"] = self["webpackChunksigi_project"] || [];
